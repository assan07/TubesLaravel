        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ url('/kelola-data-kamar/data-kamar/perempuan/update/' . $kamar->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <a href="{{ url('kelola-data-kamar/data-kamar/perempuan') }}" class="btn btn-secondary">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
