...
<head>
    ...
    <title>Login Admin - Sistem Asrama Unidayan</title>
...
<body>
                    ...
                    <div class="login-card-container w-100">
                        ...
                        <div class="card shadow-lg border-0 rounded-4">
                            <div class="card-body p-4">
                                <h4 class="card-title text-center mb-4 fw-semibold">Login Admin</h4>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="username" name="username" value="Admin1"
    ...
    <!-- Costum JS -->
    <script src="{{ asset('assets/js/mahasiswa/loginAdmin.js') }}"></script>
